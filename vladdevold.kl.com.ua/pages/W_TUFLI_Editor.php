...
<?php
			...
			// =====================
			$query = "INSERT INTO women_TUFLI (login, title, description, content, status, photo) VALUES ('$login', '$title', '$description', '$content', '$status', '$photo')";
			$conn->query($query);

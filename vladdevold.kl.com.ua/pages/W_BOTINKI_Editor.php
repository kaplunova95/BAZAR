<?php
    $title = "Женские Ботинки редактор";
...
<?php
			...
			// =====================
			$query = "INSERT INTO women_BOTINKI (login, title, description, content, status, photo) VALUES ('$login', '$title', '$description', '$content', '$status', '$photo')";
			$conn->query($query);

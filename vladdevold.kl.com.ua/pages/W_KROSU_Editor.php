<?php
    $title = "Женские Кросовки редактор";
...
<?php
			...
			// =====================
			$query = "INSERT INTO women_krosu (login, title, description, content, status, photo) VALUES ('$login', '$title', '$description', '$content', '$status', '$photo')";
			$conn->query($query);

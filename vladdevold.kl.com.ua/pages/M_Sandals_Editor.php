<?php
    $title = "Мужские Сандали редактор";
...
<?php
			...
			// =====================
			$query = "INSERT INTO men_Sandals (login, title, description, content, status, photo) VALUES ('$login', '$title', '$description', '$content', '$status', '$photo')";
			$conn->query($query);

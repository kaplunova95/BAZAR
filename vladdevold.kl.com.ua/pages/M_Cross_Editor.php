<?php
    $title = "Мужские Кросовки редактор";
...
<?php
			...
			// =====================
			$query = "INSERT INTO men_Cross (login, title, description, content, status, photo) VALUES ('$login', '$title', '$description', '$content', '$status', '$photo')";
			$conn->query($query);

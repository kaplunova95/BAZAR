<?php
    $title = "Мужские Ботинки редактор";
...
<?php
			...
			// =====================
			$query = "INSERT INTO men_Boots (login, title, description, content, status, photo) VALUES ('$login', '$title', '$description', '$content', '$status', '$photo')";
			$conn->query($query);

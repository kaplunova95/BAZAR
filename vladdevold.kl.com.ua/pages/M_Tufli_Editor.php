...
<?php
			...
			// =====================
			$query = "INSERT INTO men_Tufli (login, title, description, content, status, photo) VALUES ('$login', '$title', '$description', '$content', '$status', '$photo')";
			$conn->query($query);
